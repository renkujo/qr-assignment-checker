...
- scanner stays active across submissions, locks request handling while pending, and suppresses the same payload during a short client cooldown
- pending scans show a loading overlay; completed scans show Sonner feedback and automatically accept the next student's QR
